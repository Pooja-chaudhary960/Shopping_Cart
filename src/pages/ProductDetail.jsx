        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="flex flex-col justify-between">
            <div>
              ...
              <h2 className="text-xl font-bold text-gray-200 mb-2 border-b border-orange-900/50 pb-2 flex items-center gap-2">
                <Tag className="w-5 h-5 text-orange-500" />
                <span>Product Overview</span>
              </h2>
              <p className="text-gray-50 text-lg leading-relaxed mb-3">
                {product.description}
              </p>
              <ul className="space-y-3 text-gray-300 p-4 bg-gray-800 rounded-xl border border-gray-700">
                ...
                <li className="flex items-center space-x-3 text-lg">
                  <Zap className="w-5 h-5 text-orange-500" />
                  <span>Immediate Shipping In-Stock Items</span>
                </li>
              </ul>
